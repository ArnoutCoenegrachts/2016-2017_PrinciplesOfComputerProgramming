...
def creeerDoolhof(hoogte, breedte):
    ...
    kader_rij = "".join(kader_rij_lijst)
    doolhof.append(kader_rij)
...
def acties(h, b, doolhof):
    ...
    print("7. Nieuw doolhof aanmaken")
    print("8. Afsluiten")
...
def toonDoolhof(hoogte,doolhof):
    ...
    for i in range(hoogte):
        toon_doolhof[i+1] = "".join(toon_doolhof[i+1])
